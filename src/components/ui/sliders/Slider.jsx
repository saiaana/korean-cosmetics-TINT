...
//         }}
//         modules={[Pagination]}
//         className="pb-10 pt-4 [--swiper-pagination-bullet-inactive-color:#bbf7d0] [--swiper-pagination-bullet-inactive-opacity:1] [--swiper-pagination-color:#16a34a] md:px-6"
//         breakpoints={{
//           360: {
//             slidesPerView: 2,
//             spaceBetween: 12,
